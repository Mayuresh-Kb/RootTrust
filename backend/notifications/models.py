...
def serialize_for_dynamodb(obj):
    """
    Recursively serialize Pydantic models and datetime objects for DynamoDB.
    
    Args:
        obj: Object to serialize (dict, list, Pydantic model, datetime, etc.)
        
    Returns:
        Serialized object safe for DynamoDB
    """
    from datetime import datetime
    from pydantic import BaseModel
    
    if isinstance(obj, BaseModel):
        return serialize_for_dynamodb(obj.dict())
